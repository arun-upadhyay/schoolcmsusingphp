...
<meta name="keywords" content="balmiki education scope foundation birtamode nepal" />
<meta name="description" content="Welcome | Balmiki Education Foundation Since the establishment of Balmiki Education Foundation (which has now been transformed into Providence H." />
<title>Welcome | Suryodaya Higher Secondary School</title>
                ...
                <table width="175" height="94">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div align="left"><span style="color: rgb(204, 255, 204);"><input type="submit" name="submit" value="Go" />
                            </span>   </div> 
                            </td>
                        </tr>
                    </tbody>
   ...
   <h3>Quick Links</h3>
    ...
    <ul class="nav">
      ...
      <li><a href="download.php?Result&selectnote=All">Download Notes</a></li>
            <li><a href="admin.php?key=123&Result">Login</a></li>
...
$row = mysql_fetch_array($result);
  ...
  ?>
    ...
    <h2 style="color:#06F;"><?PHP echo $row['title']; ?> </h2><br /><div style="margin-top:-30px; margin-left:820px; margin-right:30px;"><a href="generatepdf.php?pag=<?PHP echo $idval;?>" target="_blank"><img src="images/pdf_button.png" alt="pdf" title="pdf"></a>
    <a href="#" target="_blank"><img src="images/print_button.png" alt="Print" title="print"></a>
    <a href="#" target="_blank"><img src="images/email_button.png" alt="E-mail" title="E-mail"></a></div>
        <p align="left"><?PHP echo substr($row['content'], 0,1000)."".".......<a style='color:red;' href='readmore.php?pag=1'>read more</a>";	?></p>
<hr />
<div>
  <table width="100%" >
  <tr>
	...
	$row = mysql_fetch_array($result);	
	?>
    <h3 style="color:#06F;"><?PHP echo $row['title']; ?></h3>
    <p> <?PHP echo substr($row['content'], 0,430).""."........<a style='color:red;' href='readmore.php?pag=7'>read more</a>";?></p>
	...
	?>
    <h3 style="color:#06F;"><?PHP echo $row['title']; ?></h3>
    <p> <?PHP echo substr($row['content'], 0,470).""."........<a style='color:red;' href='readmore.php?pag=13'>read more</a>";?></p>
